...
/******/ 	var hotCurrentHash = "4156e53f2e5aac562146"; // eslint-disable-line no-unused-vars
...
// module
exports.push([module.i, ".client-components-App-App_app__coDq8 {\n  width: 300px;\n  height: 250px;\n  margin: auto;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n\n.client-components-App-App_appTitle__1v5w4 {\n  text-align: center;\n}\n\n.client-components-App-App_chatInput__2IylK {\n  width: 120px;\n  margin: 5px;\n}\n\n.client-components-App-App_roomTitle__2eKaV {\n  text-align: center;\n}\n\n.client-components-App-App_messages__hE9HD {\n  width: 100%;\n  flex: 1;\n}\n\n.client-components-App-App_messageRow__2On1N {\n\n}\n\n.client-components-App-App_messageInput__2C0mk {\n  width: 100%;\n}\n", ""]);

// exports
exports.locals = {
	"app": "client-components-App-App_app__coDq8",
	"appTitle": "client-components-App-App_appTitle__1v5w4",
	"chatInput": "client-components-App-App_chatInput__2IylK",
	"roomTitle": "client-components-App-App_roomTitle__2eKaV",
	"messages": "client-components-App-App_messages__hE9HD",
	"messageRow": "client-components-App-App_messageRow__2On1N",
	"messageInput": "client-components-App-App_messageInput__2C0mk"
};
...
var _connector = __webpack_require__(78);
...
const actions = (0, _redux.bindActionCreators)(_actions2.default, store.dispatch);
const connector = new _connector2.default('ws://localhost:3000/message', actions, store);

(0, _reactDom.render)(_react2.default.createElement(
  _reactRedux.Provider,
  { store: store },
  _react2.default.createElement(_App2.default, { connector: connector })
 ...
 * LICENSE file in the root directory of this source tree.
 */
var m=__webpack_require__(9),n=__webpack_require__(10),p=__webpack_require__(2);
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(27),A=__webpack_require__(9),B=__webpack_require__(2),ca=__webpack_require__(28),da=__webpack_require__(29),ea=__webpack_require__(30),ha=__webpack_require__(31),ia=__webpack_require__(34),C=__webpack_require__(10);
...
var adapterFactory = __webpack_require__(65);
...
module.exports = function(dependencies, opts) {
  ...
  // Browser shims.
  var chromeShim = __webpack_require__(66) || null;
  var edgeShim = __webpack_require__(68) || null;
  var firefoxShim = __webpack_require__(71) || null;
  var safariShim = __webpack_require__(73) || null;
  var commonShim = __webpack_require__(74) || null;
...
module.exports = {
  ...
  shimGetUserMedia: __webpack_require__(67)
};
...
var utils = __webpack_require__(0);
var shimRTCPeerConnection = __webpack_require__(69);
...
module.exports = {
  ...
  shimGetUserMedia: __webpack_require__(72)
};
...
function configureStore(initialState) {
  ...
  return (0, _redux.createStore)(_reducers2.default, initialState, (0, _redux.applyMiddleware)(...middlewares));
}
...
exports.default = function (state = initialState, { type, payload }) {
  switch (type) {
    case 'SET_USER':
      {
        return _extends({}, state, { uid: payload.uid });
      }
    case 'ADD_MESSAGE':
      {
    ...
    case 'SET_CLIENT':
      {
        ...
        return _extends({}, state, { clients: new Map(state.clients.set(payload.uid, client)) });
      }
    case 'DELETE_CLIENT':
      {
        state.clients.delete(payload.uid);
        return _extends({}, state, { clients: new Map(state.clients) });
      }
    default:
      {
        return state;
...
class Connector {
  ...
  connect() {
    this.ws.addEventListener('open', () => {
      (0, _utils.log)('Signaling server connection success');
    });

    this.ws.addEventListener('error', () => {
      (0, _utils.log)('Signaling server connection fail');
    });
  ...
  getPeerConnection(peerId, userName) {
    ...
    peerConn.addEventListener('icecandidate', ({ candidate }) => {
      if (candidate) {
        ...
        (0, _utils.log)(`Sent ICE candidate to ${userName} (${peerId})`);
      }
    });

    peerConn.addEventListener('track', ({ streams }) => {
      (0, _utils.log)(`Received remote stream from '${userName}' (${peerId})`);
    ...
    peerConn.addEventListener('error', error => {
      (0, _utils.log)('Error when creating RTCPeerConnection');
    });
  ...
  handleJoined({ uid, userName, roomName }) {
    ...
    return _asyncToGenerator(function* () {
      (0, _utils.log)(`User '${userName}' (${uid}) has joined room '${roomName}'`);

      _this.actions.setUser(uid);
      const [err, stream] = yield (0, _utils.to)(_this.getUserMedia(userName === 'bob'));
      if (err) throw err;

      _this.actions.setClient({ uid, userName, stream });
    })();
  }

  handlePeerJoined({ peerId, userName, roomName }) {
    var _this2 = this;

    return _asyncToGenerator(function* () {
      (0, _utils.log)(`New peer '${userName}' (${peerId}) joined room '${roomName}'`);

      const peerConn = _this2.getPeerConnection(peerId, userName);

      peerConn.addEventListener('negotiationneeded', _asyncToGenerator(function* () {
        let err, offer;

        [err, offer] = yield (0, _utils.to)(peerConn.createOffer());
        if (err) throw err;

        [err] = yield (0, _utils.to)(peerConn.setLocalDescription(offer));
        if (err) throw err;
        ...
        (0, _utils.log)(`Sent offer to '${userName}' (${peerId})`);
      }));

      const [err, stream] = yield (0, _utils.to)(_this2.getUserMedia(userName === 'bob'));
      if (err) throw err;

      stream.getTracks().forEach(function (track) {
        return peerConn.addTrack(track, stream);
      });

      (0, _utils.log)(`Sent local stream to remote user '${userName}' (${peerId})`);
    })();
  }

  handleOffer({ peerId, userName, offer }) {
    var _this3 = this;

    return _asyncToGenerator(function* () {
      (0, _utils.log)(`Received offer from '${userName}' (${peerId})`);

      let err, answer, stream;
      const peerConn = _this3.getPeerConnection(peerId, userName);

      [err] = yield (0, _utils.to)(peerConn.setRemoteDescription(new RTCSessionDescription(offer)));
      if (err) throw err;

      [err, stream] = yield (0, _utils.to)(_this3.getUserMedia(userName === 'bob'));
      if (err) throw err;
      ...
      [err, answer] = yield (0, _utils.to)(peerConn.createAnswer());
      if (err) throw err;

      [err] = yield (0, _utils.to)(peerConn.setLocalDescription(answer));
      if (err) throw err;
      ...
      (0, _utils.log)(`Sent answer to '${userName}' (${peerId})`);
    })();
  }

  handleAnswer({ peerId, userName, answer }) {
    var _this4 = this;

    return _asyncToGenerator(function* () {
      (0, _utils.log)(`Received answer from '${userName}' (${peerId})`);

      const { peerConn } = _this4.getClient(peerId);
      const [err] = yield (0, _utils.to)(peerConn.setRemoteDescription(new RTCSessionDescription(answer)));
      if (err) throw err;
    })();
  }

  handleCandidate({ peerId, userName, candidate }) {
    var _this5 = this;

    return _asyncToGenerator(function* () {
      (0, _utils.log)(`Received ICE candidate from '${userName}' (${peerId})`);

      const { peerConn } = _this5.getClient(peerId);
      const [err] = yield (0, _utils.to)(peerConn.addIceCandidate(new RTCIceCandidate(candidate)));
      if (err) throw err;
    })();
  }
  ...
  handlePeerLeft({ peerId, userName }) {
    (0, _utils.log)(`Peer '${userName}' (${peerId}) has left`);
  ...
  render() {
    ...
    return _react2.default.createElement(
      ...
      !uid ? _react2.default.createElement(
        ...
        _react2.default.createElement(
          'h2',
          { className: _App2.default.roomTitle },
          'Start a chatroom'
        ),
        _react2.default.createElement('input', {
          className: _App2.default.chatInput,
          name: 'roomName',
        ...
        _react2.default.createElement(
          'div',
          { className: _App2.default.messages },
          messages.map(msg => _react2.default.createElement(
            'div',
            { key: msg.mid },
        ...
        _react2.default.createElement('input', {
          className: _App2.default.messageInput,
          name: 'message',
        ...
        Array.from(clients).filter(([, peer]) => peer.stream).map(([id, peer]) => _react2.default.createElement('audio', {
          key: id,
          autoPlay: true,
          src: peer.stream
        }))
...
App.propTypes = {
  connector: _propTypes2.default.object.isRequired,
  clients: _propTypes2.default.object.isRequired,
...
exports.default = (0, _reactRedux.connect)(state => ({
  ...
  addMessage: (userName, message) => dispatch(_actions2.default.addMessage(userName, message))
}))(App);
